...
def auth_login():
    ...
    # Generate redirect URI dynamically based on request
...
Write the NEWS section now. Output the three subsections with bold labels (*The Short Version:*, *What's Happening:*, *Why It Matters for Venues:*). Use plain text with line breaks between sections."""
                ...
                for p in paragraphs:
                    ...
                    p = p.replace('\n', ' ')
                    formatted_paragraphs.append(f'<p style="margin: 0 0 16px 0; font-family: \'Gilroy\', Trebuchet MS, sans-serif; font-size: 15px; color: #555555; line-height: 1.7;" class="dark-text-secondary">{p}</p>')
...
Write the TIP body paragraph now. Output ONLY the paragraph text, no title or formatting."""
                ...
                sections['tip'] = f'''<p style="margin: 0 0 16px 0; font-family: 'Gilroy', Trebuchet MS, sans-serif; font-size: 15px; color: #555555; line-height: 1.7;" class="dark-text-secondary">{tip_text}</p>'''
...
Write the TREND body paragraph now. Output ONLY the paragraph text, no title or formatting."""
                ...
                # Build HTML - subtitle separate, content without asterisks
                sections['trend'] = f'''<p style="margin: 0 0 16px 0; font-family: 'Gilroy', Trebuchet MS, sans-serif; font-size: 15px; color: #555555; line-height: 1.7;" class="dark-text-secondary">{trend_text}</p>'''
...
<p>Brief explanation here.</p>"""
            ...
            if '<p>' in news_content:
                ...
                if match:
                    ...
                    news_content = f'<p style="margin: 0 0 16px 0; font-family: \'Gilroy\', Trebuchet MS, sans-serif; font-size: 15px; color: #555555; line-height: 1.7;" class="dark-text-secondary">{text}</p>'
...
<p>Short tip sentence here.</p>"""
            ...
            if '<p>' in tip_content:
                ...
                if match:
                    ...
                    tip_content = f'<p style="margin: 0 0 16px 0; font-family: \'Gilroy\', Trebuchet MS, sans-serif; font-size: 15px; color: #555555; line-height: 1.7;" class="dark-text-secondary">{text}</p>'
...
<p>Short trend sentence here.</p>"""
            ...
            if '<p>' in trend_content:
                ...
                if match:
                    ...
                    trend_content = f'<p style="margin: 0 0 16px 0; font-family: \'Gilroy\', Trebuchet MS, sans-serif; font-size: 15px; color: #555555; line-height: 1.7;" class="dark-text-secondary">{text}</p>'
